...
const SENSITIVE_KEY_PATTERN =
  /(^|[^a-z])(api[-_ ]?key|authorization|bearer|client[-_ ]?secret|credentials?|oauth|access[-_ ]?token|password|passphrase|private[-_ ]?key|refresh[-_ ]?token|secret|token)([^a-z]|$)/i;
